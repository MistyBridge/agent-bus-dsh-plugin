...
function defaultDagNoteGeom(): NoteGeom {
  const w = 680
  const h = Math.min(640, Math.max(360, window.innerHeight - 80))
  return {
...
export function TaskPanel({ sessionsList }: TaskPanelProps): JSX.Element {
  ...
  const [dagSessionFilter, setDagSessionFilter] = useState<string | null>(null)
          ...
          <div className={css.abPNoteBody}>
            <aside className={css.abPDrawer}>
              ...
              <DagView
                ...
                currentSessionId={currentSessionId}
                sessionFilter={dagSessionFilter}
                onSessionFilter={setDagSessionFilter}
